            ...
            {!! Form::open(['route'=>['admin.absences.update', $absence->id], 'method'=>'put','class'=>'form-horizontal']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <label for="inputName3" class="col-sm-10 control-label"> {{ $absence->student->student_code }}</label>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <label for="inputName3" class="col-sm-10 control-label"> {{ $absence->subject->subject_name }}</label>
                    </div>
