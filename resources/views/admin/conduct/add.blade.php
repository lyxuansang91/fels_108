    ...
    <div class="col-md-8">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Create new conduct</h3>
            </div><!-- /.box-header -->
            <!-- form start -->
            {!! Form::open(['route'=>'admin.conducts.store', 'class'=>'form-horizontal']) !!}
                <div class="box-body">
                    @if(count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::text('conduct_name', '', ['class'=>'form-control', 'pladeholder'=> 'Input conduct name']) !!}
                        </div>
                    </div>
